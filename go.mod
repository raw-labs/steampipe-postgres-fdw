...
require (
	...
	github.com/turbot/steampipe-plugin-sdk/v5 v5.11.0-alpha.1.raw-patch-2
...
replace (
	...
	github.com/turbot/steampipe-plugin-sdk/v5 => github.com/raw-labs/steampipe-plugin-sdk/v5 v5.11.0-alpha.1.raw-patch-2
